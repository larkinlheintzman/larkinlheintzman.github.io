...
/** @type {string} */
const CACHE_VERSION = '1732238255|7596142107';
/** @type {string} */
const CACHE_PREFIX = 'ModularMachines-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'ModularMachines_v1.2.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["ModularMachines_v1.2.html","ModularMachines_v1.2.js","ModularMachines_v1.2.offline.html","ModularMachines_v1.2.icon.png","ModularMachines_v1.2.apple-touch-icon.png","ModularMachines_v1.2.worker.js","ModularMachines_v1.2.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["ModularMachines_v1.2.wasm","ModularMachines_v1.2.pck"];
